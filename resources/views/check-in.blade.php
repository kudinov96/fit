                    ...
                    <form class="need-validation settings-form" method="POST" action="{{ route("check-in.store") }}" novalidate>
                        ...
                        <div class="qs-inputs row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <input name="water" type="text" value="" class="form-control float-input" tabindex="0" required>
                            </div>
                            <div class="col-lg-3">
                                <label>{{ __('Сон') }} <span>{{ __('(часов)') }}</span></label>
                                <input name="sleep" type="text" value="" class="form-control float-input" tabindex="0" required>
                            </div>
                            <div class="col-lg-3">
                            ...
                            <div>
                                ...
                                <div class="qs-inputs row mb-4">
                                    <div class="col-xl-2">
                                        ...
                                        <input name="weight" type="text" value="" class="form-control float-input" required>
                                    </div>
                                    <div class="col-xl-2">
