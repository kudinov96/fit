            ...
            @if($user->firstQuiz)
                <div class="result-box">
                    <div class="result-row">
                        <p>Параметры:</p>
                        <ul>
                            <li><span>Вес:</span> {{ $user->firstQuiz->weight }} кг;</li>
                            <li><span>Рост:</span> {{ $user->firstQuiz->height }} см;</li>
                            <li><span>Возраст:</span> {{ $user->firstQuiz->age }} лет;</li>
                        </ul>
                    </div>
                    <div class="result-row">
                        <p>Цель:</p>
                    ...
                    <div class="result-row">
                        <p>Прием лекарств или пищевых добавок:</p>
                        <p>{{ $user->firstQuiz->nutritional_supplements }}</p>
                    </div>
                    <div class="result-row">
                        <p>Были проблемы со здоровьем:</p>
                        <p>{{ $user->firstQuiz->health_problems }}</p>
                    </div>
                    <div class="result-row">
                        <p>Был частный тренер/личные тренировки/план питания?</p>
                ...
                <div class="row">
                    <div class="col-lg-6 stat-start stat-start_member">
                        <div>
                            ...
                            <p>Рост: <span>{{ $user->firstQuiz->height }} см</span></p>
                            <p>Возраст: <span>{{ $user->firstQuiz->age }} лет</span></p>
                        </div>
                    </div>
                    <div class="col-lg-6 stat-pics">
                        ...
                        @else
                            <a class="stat-pic_empty">
                                <span>Фото еще<br> не загружено</span>
                            </a>
                        @endif
            ...
            <div class="member-reports">
                ...
                <ul class="nav nav-pills nav-fill justify-content-center" id="pills-week" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pills-week1-tab" data-bs-toggle="pill" data-bs-target="#pills-week1" type="button" role="tab" aria-controls="pills-week1" aria-selected="true">Первая неделя</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-week2-tab" data-bs-toggle="pill" data-bs-target="#pills-week2" type="button" role="tab" aria-controls="pills-week2" aria-selected="false">Вторая неделя</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-week3-tab" data-bs-toggle="pill" data-bs-target="#pills-week3" type="button" role="tab" aria-controls="pills-week3" aria-selected="false">Третья неделя</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-week4-tab" data-bs-toggle="pill" data-bs-target="#pills-week4" type="button" role="tab" aria-controls="pills-week4" aria-selected="false">Четвертая неделя</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-week5-tab" data-bs-toggle="pill" data-bs-target="#pills-week5" type="button" role="tab" aria-controls="pills-week5" aria-selected="false">Пятая неделя</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-week6-tab" data-bs-toggle="pill" data-bs-target="#pills-week6" type="button" role="tab" aria-controls="pills-week6" aria-selected="false">Шестая неделя</button>
                    </li>
                </ul>
                <div class="tab-content" id="pills-tabContent_week">
                    ...
                    {{--<div class="tab-pane fade" id="pills-week2" role="tabpanel" aria-labelledby="pills-week2-tab" tabindex="0">
                        <div class="week-wrapper">
                            <div class="week-title">Твои результаты за вторую неделю:</div>
                            <div class="table-responsive">
                                <table class="table table-dark">
                                    <thead>
                                    <tr>
                                        <th scope="col"></th>
                                        <th scope="col">пн, 14.03.24</th>
                                        <th scope="col">вт, 15.03.24</th>
                                        <th scope="col">ср, 16.03.24</th>
                                        <th scope="col">чт, 17.03.24</th>
                                        <th scope="col">пт, 18.03.24</th>
                                        <th scope="col">сб, 19.03.24</th>
                                        <th scope="col">вс, 20.03.24</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="week-title">Твои параметры за вторую неделю:</div>
                        ...
                        <div class="week-wrapper">
                            ...
                            <div class="comment-form">
                                <form class="needs-validation settings-form" novalidate>
                                    <div class="form-item">
                                        <textarea name="comment" value="" class="form-control" required></textarea>
                    ...
                    <div class="tab-pane fade" id="pills-week3" role="tabpanel" aria-labelledby="pills-week3-tab" tabindex="0">
                        <div class="week-wrapper">
                            <div class="week-title">Твои результаты за третью неделю:</div>
                            <div class="table-responsive">
                                <table class="table table-dark">
                                    <thead>
                                    <tr>
                            ...
                            <div class="week-title">Твои параметры за третью неделю:</div>
                            <div class="week-results">
                                <p>Вес: <span>57 кг</span></p>
                                <p>Грудь: <span>80 см</span></p>
                                <p>Талия: <span>68 см</span></p>
                    ...
                    <div class="tab-pane fade" id="pills-week4" role="tabpanel" aria-labelledby="pills-week4-tab" tabindex="0">
                        <div class="week-wrapper">
                            <div class="week-title">Твои результаты за четвертую неделю:</div>
                            <div class="table-responsive">
                                <table class="table table-dark">
                                    <thead>
                                    <tr>
                            ...
                            <div class="week-title">Твои параметры за четвертую неделю:</div>
                            <div class="week-results">
                                <p>Вес: <span>57 кг</span></p>
                                <p>Грудь: <span>80 см</span></p>
                                <p>Талия: <span>68 см</span></p>
                    ...
                    <div class="tab-pane fade" id="pills-week5" role="tabpanel" aria-labelledby="pills-week5-tab" tabindex="0">
                        <div class="week-wrapper">
                            <div class="week-title">Твои результаты за пятую неделю:</div>
                            <div class="table-responsive">
                                <table class="table table-dark">
                                    <thead>
                                    <tr>
                            ...
                            <div class="week-title">Твои параметры за пятую неделю:</div>
                            <div class="week-results">
                                <p>Вес: <span>57 кг</span></p>
                                <p>Грудь: <span>80 см</span></p>
                                <p>Талия: <span>68 см</span></p>
                    ...
                    <div class="tab-pane fade" id="pills-week6" role="tabpanel" aria-labelledby="pills-week6-tab" tabindex="0">
                        <div class="week-wrapper">
                            <div class="week-title">Твои результаты за шестую неделю:</div>
                            <div class="table-responsive">
                                <table class="table table-dark">
                                    <thead>
                                    <tr>
                            ...
                            <div class="week-title">Твои параметры за шестую неделю:</div>
                            <div class="row">
                                ...
                                <div class="col-lg-6 stat-pics">
                                    <a data-fancybox="user-gallery" href="images/foto-4.png"><img src="images/foto-4.png" alt=""></a>
                                    <a data-fancybox="user-gallery" href="images/foto-5.png"><img src="images/foto-5.png" alt=""></a>
                                    <a data-fancybox="user-gallery" href="images/foto-6.png"><img src="images/foto-6.png" alt=""></a>
                                </div>
                            </div>
                        </div>
                        <div class="week-wrapper">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="modal-title">Загрузить другое меню</div>
                    <form class="needs-validation settings-form" method="POST" action="{{ route("user.update.menu", ["user" => $user]) }}" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="form-file form-item">
                            <label class="control-label">Загрузить шаблон листа для старта</label>
    ...
    <div class="modal fade" id="thanksModal" tabindex="-1" aria-labelledby="thanksModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="modal-title">Меню загружено</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="commentModal" tabindex="-1" aria-labelledby="commentModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="modal-title mb-0">Комментарий добавлен</div>
                </div>
            </div>
        </div>
    </div>
