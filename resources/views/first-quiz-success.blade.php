...
@section("content")
    ...
    <div id="page">
        <div class="quiz-wrapper d-block">
            <div class="quiz-head">
                <a href="{{ route("marathon.index") }}" class="quiz-goback">
            ...
            <form class="quiz-slider_wrapper">
                <div class="quiz-count">{{ __('Спасибо за участие!') }}</div>
                <div class="quiz-slider">
                    <div class="quiz-slide_item step-7">
                        <div class="thanks-wrapper">
                            <p>{{ __('Твои ответы отправлены!') }}</p>
                            <p>{{ __('Вскоре в личном кабинете появится индивидуальный план питания, подобранный на основе твоих ответов.') }}</p>
                            <p>{{ __('До встречи на проекте!') }}</p>
                            <p><a href="{{ route("marathon.index") }}" class="btn">{{ __('в кабинет') }}</a></p>
                        </div>
                    </div>
                </div>
            </form>
