        ...
        <div class="container">
            ...
            <div class="row-gallery">
                ...
                <div class="gallery-noty">
                    <p>{{ __("ВНИМАНИЕ!") }}</p>
                    <p>{{ __("competition-message") }}</p>
                    <p><strong>{{ __("download-tempalte-msg") }}</strong></p>
                    <p>
                    ...
                    <div class="form-fields">
                        ...
                        <div class="d-flex">
                            ...
                            <div>
                                ...
                                <input name="breast" type="number" step="1" min="1" class="form-control numeric-input" required>
                            </div>
                            <div>
