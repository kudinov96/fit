                    ...
                    <div class="quiz-slide_item step-1">
                        ...
                        <div class="qs-inputs row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <input name="height" type="number" step="0.1" min="0.1" class="form-control quiz-required float-input">
                            </div>
                            <div class="col-lg-4">
                                <label>{{ __('Вес') }} <span>({{ __('кг') }})</span></label>
                                <input name="weight" type="number" step="0.1" class="form-control quiz-required float-input">
                            </div>
                        </div>
                    </div>
